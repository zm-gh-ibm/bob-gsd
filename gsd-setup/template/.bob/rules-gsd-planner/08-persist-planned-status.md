...
writing the plan to `.gsd/CONTEXT.md` and STOPs at the plan-approval gate (rule:
...
1. After `.gsd/CONTEXT.md` is fully written, open `.gsd/STATE.md`.
...
3. Write `STATE.md` in canonical format per
   [`.gsd/STATE.schema.md`](../../.gsd/STATE.schema.md) (plain `key: value`, header `# STATE`,
