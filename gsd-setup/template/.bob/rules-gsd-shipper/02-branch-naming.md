...
- The slug is derived from the phase title in `.gsd/ROADMAP.md` (lowercase, hyphens,
  no spaces).
- If the branch does not follow this convention, note it in the PR body under
  "Branch note:" but do NOT block the ship.
- If the project has a branch strategy documented in `.gsd/PROJECT.md`, that takes
